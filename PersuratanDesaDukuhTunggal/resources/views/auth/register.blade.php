            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="jenis" class="col-md-4 col-form-label text-md-right">{{ __('Jenis Kelamin') }}</label>
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="jenis" type="text" class="form-control" name ="jenis" class="form-control @error('jenis') is-invalid @enderror">
                        ...
                        <div class="form-group row">
                            <label for="kelurahan" class="col-md-4 col-form-label text-md-right">{{ __('Kelurahan/Desa') }}</label>
