...
<body>
    ...
    <div id="preloader">
        <div class="loader">
        <img  width="1000px" src="logo/Lambang_Kabupaten_Lamongan.png" alt="Image placeholder" class="img-fluid">
    ...
    <!-- ***** Hero Area Start ***** -->
    <div class="fancy-hero-area bg-img bg-overlay animated-img" style="background-image: url(img/bg-img/hero-1.png);">
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="fancy-hero-content text-center">
                        <!-- Video Overview -->
                        <h2>Profile Desa Dukuh Tunggal</h2>
                        <iframe width="600" height="315"
                            src="https://www.youtube.com/embed/Vkg00yaK5_w">
                        </iframe>
                        <div class="video-overview">
                        <a href="https://www.youtube.com/watch?v=Vkg00yaK5_w" class="video--play--btn"><i class="fa fa-play" aria-hidden="true"></i> Putar Fullscreen Profile Desa Dukuh Tunggal</a>
    ...
    <!-- ***** Blog Area Start ***** -->
    <section class="fancy-blog-area section-padding-100-70"  id='artikel'>
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section-heading text-center">
                        <h2>Informasi Potensi Desa</h2>
                    </div>
                </div>
            </div>
            ...
            @foreach($artikel as $a)
                ...
                <div class="col-12 col-md-4">
                    ...
                    <img width="1500px" src="{{ url('/file_gambar/'.$a->Foto1) }}" alt="">
                        <div class="blog-content">
                            <h5><a href="static-page.html">{{$a->judul}}</a></h5>
                            <p>{{substr($a->isi,0,100)}}.</p>
                            <p>Tag : {{$a->nama}}</p>
                            <a href="/detail-artikel/{{$a->id}}">Baca Selengkapnya</a>
                        </div>
                    </div>
                </div>
            @endforeach
